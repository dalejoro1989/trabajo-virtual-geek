...
console.log(`My name is ${firstDogImage} ${firstDogName}.`);

const secondDogImage = 'https://images.dog.ceo/breeds/malamute/n02110063_642.jpg';
const secondDogName = 'Luna';
console.log(`My name is ${secondDogImage} ${secondDogName}.`);

const thirdDogImage = 'https://images.dog.ceo/breeds/chihuahua/n02085620_3409.jpg';
const thirdDogName = 'Lana';
console.log(`My name is ${thirdDogImage} ${thirdDogName}.`);



//document.querySelector('body').innerHTML =`My name is ${thirdDogImage} ${thirdDogName}.`;